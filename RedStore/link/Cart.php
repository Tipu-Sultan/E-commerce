...
<div><a href="index.php"><i class="fas fa-arrow"></i></a></div>
<body class="bg-light">
...
<img src="../product/<?php echo $_SESSION['image']?>"alt="?" >
</div>
<?php
...
<p><i class="fas fa-trash-alt"><a href="user.php?id=<?php echo  $_SESSION['id'] ?>" style="color: #fff;"></a>BUY</i></p>
