<style>
	...
	*{
	...
	body{
		font-family: 'Roboto', sans-serif;background: #0f171e;
...
background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(28,222,193,0.8606793059020483) 66%, rgba(0,212,255,1) 100%);
		color: #ff523b;
		border-radius: 10px;
	}
	.navbar{
